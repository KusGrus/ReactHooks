...
import withModify from "./withModify";

const HocExercise = () => {
    const [state, setState] = useState(false);
    const SimpleComponentWithModify = withModify(SimpleComponent);
    ...
    return (
        <>
            ...
            <SimpleComponentWithModify onLogin={handleLogin} onLogOut={handleLogout}/>
        </>
    );
};
